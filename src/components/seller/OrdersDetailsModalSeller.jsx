...
const OrderDetailsModalSeller = ({ isOpen, onClose, orderId, tax, shipping_fee, admin_fee, total_amount}) => {
  ...
  const fetchOrderDetails = async () => {
    ...
    try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/order_details/${orderId}`, {
            method: 'GET',
            headers: {
...
export default OrderDetailsModalSeller;